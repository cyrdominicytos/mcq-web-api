 ...
 */
@Service
public class YamlParsersService<K> {
     ...
     * @param yamlContent
     * @return K, the reponse entity for the yaml parsing (ex : QuestionYamlDTO)
     * @throws Exception
     */
    public K parseYaml(String yamlContent, Class<K> type) throws  Exception{
        try
        {
